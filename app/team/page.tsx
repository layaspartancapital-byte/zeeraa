...
const team = [
  {
    name: "Marcus Chen",
    role: "Founder & CEO",
    bio: "Former Amazon category manager with 10+ years in eCommerce",
    gradient: "from-blue-500 to-cyan-400",
  },
  {
    name: "Sarah Williams",
    role: "VP of Operations",
    bio: "Scaled 200+ brands across 30+ platforms",
    gradient: "from-purple-500 to-pink-400",
  },
  {
    name: "David Park",
    role: "Head of Advertising",
    bio: "Managed $20M+ in marketplace ad spend",
    gradient: "from-orange-500 to-yellow-400",
  },
  {
    name: "Lisa Martinez",
    role: "Director of Client Success",
    bio: "Specialist in multi-platform growth strategy",
    gradient: "from-green-500 to-emerald-400",
  },
  {
    name: "James Thompson",
    role: "Lead SEO Strategist",
    bio: "Driven 500M+ organic impressions for eCommerce brands",
    gradient: "from-red-500 to-rose-400",
  },
  {
    name: "Priya Sharma",
    role: "TikTok Shop Lead",
    bio: "Built TikTok Shop programs generating $5M+ monthly",
  ...
  const schema = [
    {
      ...
      description:
        "Meet the team behind Zeeraa. eCommerce experts with decades of combined experience.",
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-text-muted text-lg max-w-2xl mx-auto">
              eCommerce experts with decades of combined experience driving
              growth across every major platform.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {team.map((member) => (
              <div
                key={member.name}
                className="rounded-xl border border-border bg-card/60 backdrop-blur-sm p-8 hover:border-primary/40 hover:shadow-glow transition-all duration-300 text-center"
              >
                {/* Gradient placeholder for photo */}
                <div
                  className={`w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-br ${member.gradient} flex items-center justify-center`}
                >
